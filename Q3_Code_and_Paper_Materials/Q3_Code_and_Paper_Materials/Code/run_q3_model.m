...
cases(2).mode = 'coheat';
% 在本轮gammaIce=3.5、kFreeze=0.4粗网格试算中，原候选会先触及低压阈值。
% 先用全片1 W/cm^2作为可运行的连通性候选；这不是优化解。
cases(2).powerDensityWcm2 = ones(1,5);
