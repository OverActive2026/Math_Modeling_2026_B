...
currentLevelsAcm2 = [0.15 0.18 0.30 0.40]; % 未优化、可启动的四段基准 [A/cm^2]
switchTimesS = [5 15 35];                  % 未优化基准的切换时刻 [s]
...
simOpt.kFreeze = 0.4; % 1/s; same phase-change setting as optimized linear loading.
simOpt.gammaIce = 3.5; % Same CCL ice-coverage exponent as optimized linear loading.
simOpt.kMelt = 1;
